...
`,e=>{e=e.target;e!==modalElem&&!e.closest(".modal__close")||(modalElem.style.opacity=0,setTimeout(()=>{modalElem.style.visibility="hidden"},300))}),openModal=()=>{modalElem.style.visibility="visible",modalElem.style.opacity=1};buttonElems.forEach(e=>{e.addEventListener("click",openModal)}),modalElem.addEventListener("click",closeModal);